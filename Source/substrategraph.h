...
public:
    ...
    typedef ArcMap <Weight>             ArcWeightMap;
    typedef EdgeMap<Weight>             EdgeWeightMap;
    typedef NodeMap<Weight>             DistMap;
    typedef NodeMap<Supply>             SupplyMap;
    typedef ArcMap <Capacity>           FlowMap;
    typedef CostScaling<SubstrateGraph> MinCostFlow;
    ...
    EdgeWeightMap   _edgeWeight;
    ArcWeightMap    _arcWeight;
    
public:
    SubstrateGraph();
    SubstrateGraph(Graph&);
    
    virtual Arc      arc     (Node, Node);
    virtual Arc      oposArc (Arc a);
